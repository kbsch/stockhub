// FRED API service for economic indicators
// Note: FRED requires an API key for production use
// For now, we'll map common indicators to Yahoo Finance equivalents where possible

export interface FredSeries {
  id: string;
  name: string;
  yahooSymbol?: string; // Fallback to Yahoo if available
}

// Common economic indicators mapped to their FRED series IDs and Yahoo equivalents
